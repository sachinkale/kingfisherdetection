...
DRIVER_PATH = '/Users/xxx/work/scraping/chromedriver'
...
def fetch_image_urls(query: str, max_links_to_fetch: int, wd: webdriver, sleep_between_interactions: int = 1):
    ...
    image_count = 0
    results_start = 0
    sleep_between_interactions = randrange(10)
    #time.sleep(60)
...
if __name__ == '__main__':
    ...
    queries = ["Javan Kingfisher","Lilac Kingfisher","Silvery Kingfisher","Spotted Kingfisher"]
    for query in queries:
        ...
        images_path = '/Users/xxx/work/scraping/imscraped2'
        for i in links:
